"use client";
import { Box, Flex, Heading, Text, Note, Badge, Spinner, Button } from "@contentful/f36-components";
...
export function SidebarPanel() {
  ...
  return (
    <Box padding="spacingM">
      ...
      <Text>Keeps your page segments and full paths clean and collision-free.</Text>
        ...
        {preview ? (
          <Note variant="positive">
            <Flex alignItems="center" flexWrap="wrap" style={{ gap: "8px" }}>
              ...
              <Text as="span" style={{ fontFamily: "monospace" }}>{preview.segment || "—"}</Text>
              <Badge variant="secondary">fullPath</Badge>
              <Text as="span" style={{ fontFamily: "monospace" }}>{preview.fullPath || "—"}</Text>
            </Flex>
          </Note>
        ) : (
